...
### I99. Handle-table in-memory `depth` not restored on rollback — silent corruption after a rolled-back grow [internal 2026-06-02] — **P1 (critical correctness — silent data loss)**
